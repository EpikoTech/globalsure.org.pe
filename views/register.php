...
<head>
    ...
    <script src="registroajax.js"></script> <!-- Archivo JS para manejo de AJAX -->
</head>
<body>
    <div class="container">
        <h2>REGISTRO DE NUEVO USUARIO</h2>
        <form id="registroForm"> <!-- Se añade el id para identificar el formulario -->
            ...
            <button type="submit" id="btnGuardar">Guardar</button> <!-- Se añade el id para el botón de envío -->
        </form>
